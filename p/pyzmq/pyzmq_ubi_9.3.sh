...
pip install cython==3.0.12 packaging==24.2 pathspec==0.12.1 scikit-build-core==0.11.1 cmake==3.27.9 ninja==1.11.1.4 build pytest
...
# Run tests
if ! pytest -v  --capture=no -p no:warnings --ignore=tests/test_draft.py; then
