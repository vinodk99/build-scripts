...
yum install -y java-17-openjdk java-17-openjdk-devel java-17-openjdk-headless git wget
...
ln -sf /usr/local/apache-maven-3.9.7/bin/mvn /usr/bin/mvn
...
#Build
if ! mvn -B clean install -fae -Dmaven=3.9.7 ; then
